...
This document dedicates to doing commits and messages with good practice. This concern was raised when tags were used outside of standard practice. On 2/6/2026 this repository will align with industry standard.
...
3. A pull request and merge commit
