...
export function createChassis(b: Builder, m: CarMaterials): ChassisRig {
  ...
  const ez = -0.07;
  b.box(0.5, 0.28, 0.58, m.engine, { x: 1.3, y: 0.64, z: ez });
  b.box(0.4, 0.08, 0.46, m.engineCover, { x: 1.3, y: 0.82, z: ez });
  b.cyl(0.1, 0.1, 0.05, m.metalDark, { x: 1.25, y: 0.885, z: ez - 0.06 });
  b.cylX(0.03, 0.14, m.rubber, { x: 1.19, y: 0.885, z: ez - 0.06 });
  b.cylX(0.09, 0.03, m.metalDark, { x: 1.035, y: 0.6, z: ez + 0.04 });
  b.cylX(0.04, 0.03, m.metal, { x: 1.035, y: 0.78, z: ez - 0.16 });
  b.box(0.04, 0.3, 0.64, m.metalDark, { x: 1.82, y: 0.65 });
  b.cylX(0.14, 0.02, m.metal, { x: 1.78, y: 0.65, z: 0 });
  b.box(0.2, 0.16, 0.2, m.rubber, { x: 1.7, y: 0.58, z: -0.24 });
  b.cyl(0.012, 0.012, 0.03, m.chrome, { x: 1.65, y: 0.675, z: -0.3 });
  b.cyl(0.012, 0.012, 0.03, m.chrome, { x: 1.75, y: 0.675, z: -0.3 });
  b.cyl(0.05, 0.05, 0.14, m.paper, { x: 1.65, y: 0.57, z: 0.3 });
